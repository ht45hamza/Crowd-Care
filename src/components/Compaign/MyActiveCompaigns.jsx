...
export default function MyActiveCompaigns({ campaigns = [] }) {
                ...
                return (
                    ...
                    >
                        ...
                        <div className="flex flex-1 flex-col justify-center py-2 pr-2">
                            <h3 className="text-black font-bold text-[19px] sm:text-[21px] mb-8">
                                {item.title}
                            </h3>
                            ...
                            <div className="w-full flex-col mb-4">
                                <div className="flex justify-end w-full">
                                    <span className="text-[12px] font-bold text-gray-500 mb-1">
                                        %{progress}
                                    </span>
                                </div>
